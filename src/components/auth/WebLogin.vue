  ...
  <div class="container-fluid py-5" style="background-color: #f5f5f5">
    <div style="background-color: #ffffff; width: 400px; min-height: 100vh" class="p-5 m-auto login-form">
      ...
      <form @submit.prevent="login">
        <div class="my-4">
          <!-- Email -->
          <base-input type="email" identity="email" placeholder="Your email address" label="Email" v-model="loginData.email"></base-input>
        </div>
        <div class="my-4">
          <!-- Password -->
      ...
      <div class="text-center mt-4">
        <p class="fw-semibold">
          Don’t have an account?<router-link to="/signup" style="color: #4c4ddc"> <a to="/signup" class="text-decoration-none"> Signup</a></router-link>
        </p>
      </div>
    </div>
  </div>
